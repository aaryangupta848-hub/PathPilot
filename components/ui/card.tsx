...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "glass-panel surface-highlight rounded-[1.75rem] shadow-panel transition duration-300 hover:border-white/15 hover:shadow-[0_40px_120px_-60px_rgba(0,0,0,0.95)]",
        className
      )}
      {...props}
    />
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("text-xl font-semibold tracking-tight text-foreground/95", className)} {...props} />
  )
);
